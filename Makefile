...
TEMPLATE_PATH := ../nRF5_SDK_canopy_project/components/toolchain/gcc
ifeq ($(OS),Windows_NT)
...
C_SOURCE_FILES += \
  ...
  $(SDK_PATH)/external/segger_rtt/RTT_Syscalls_KEIL.c \
...
INC_PATHS += \
  ...
  -I$(SDK_PATH)/components/libraries/fifo \
  ...
  -I$(SDK_PATH)/components/drivers_nrf/spi_slave \
...
nrf52832_xxaa: LINKER_SCRIPT=senseback_controller.ld
